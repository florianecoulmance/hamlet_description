...
data_path <- "/Users/fco/Desktop/PhD/HAMLET_DESCRIPTION_PAPER/hamlet_description/figures/snp_nofloridae_0.5_nomaf_pca.RData"
var_path <- "/Users/fco/Desktop/PhD/HAMLET_DESCRIPTION_PAPER/hamlet_description/figures/snp_nofloridae_0.5_nomaf_eixplained_var.tsv"
figure_path<- "/Users/fco/Desktop/PhD/HAMLET_DESCRIPTION_PAPER/hamlet_description/figures/"
out_prefix <- "snp_nofloridae_0.5_nomaf_pca"
...
logos_spec <- c(abe = "<img src='/Users/fco/Desktop/PhD/1_CHAPTER1/0_IMAGES/after_python/logos/H_aberrans.l.cairo.png' width='120' /><br>*H. aberrans*",
  ...
  tan = "<img src='/Users/fco/Desktop/PhD/1_CHAPTER1/0_IMAGES/after_python/logos/H_tan.l.cairo.png' width='120' /><br>*H. affinis*",
...
p3 <- ggplot(data,aes(x=PC1,y=PC3,color=spec)) + geom_point(size = 7) +
...
p4 <- ggplot(data,aes(x=PC2,y=PC3,color=spec)) + geom_point(size = 7) +
...
f <- ggarrange(p1, p3, p4, common.legend = TRUE, legend="bottom",ncol = 3, nrow = 1)
