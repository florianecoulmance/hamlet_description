...
INPUT_META=$BASE_DIR/metadata/metadata
...
Rscript --vanilla $BASE_DIR/R/pca.R $BASE_DIR/outputs/6_genotyping/6_1_snp/\${PREFIX}.vcf.gz $BASE_DIR/figures/ \${PREFIX}_0.5_maf0.02
